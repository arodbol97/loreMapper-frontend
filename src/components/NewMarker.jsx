...
const NewMarker = ({ worldId , mapId, handleListChange, type, map, displayMarkers, hideMarker, user}) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
          const response = await axios.post('https://lore-mapper-backend.vercel.app//marker/createandplace', formData);          
    ...
    const handleSubmit2 = async (event) => {
        ...
        try {
          const response = await axios.post('https://lore-mapper-backend.vercel.app//markerInMap', formData);          
