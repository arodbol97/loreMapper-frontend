...
const PasswordReset = ({ handleComponentChange , encryptedEmail = null }) => {
  ...
  const decrypt = async () => {
    try {
      const response = await axios.post('http://localhost:3001/user/passwordresetcheck', {encryptedEmail: encryptedEmail});
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('http://localhost:3001/user/passwordreset', formData);
