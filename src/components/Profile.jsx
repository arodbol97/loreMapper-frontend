...
const Profile = ({handleComponentChange, user, logged = false, profileUser}) => {
  ...
  const getWorlds = async () => {
    try {          
      const response = await axios.get(`http://localhost:3001/world/fromUserId/${user.userId}`);
  ...
  const handleNameSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('http://localhost:3001/user/changeName', formData);
  ...
  const handleEmailSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('http://localhost:3001/user/changeEmail', formData);
      const requestData = response.data.userData;
      if (!requestData.updated) {
        document.getElementById('formError').innerHTML = requestData.error;
      } else {
        await axios.post('http://localhost:3001/user/verifyStart', {usernameOrEmail: formData.userEmail});
  ...
  const handlePasswordSubmit = async (e) => {
    ...
    try {
      if (formData.password === formData.repeatPassword) {
        ...
        const response = await axios.post('http://localhost:3001/user/passwordresetcomplete', formData);
  ...
  const handleRolSubmit = async (event) => {
    ...
    try {
      const response = await axios.post('http://localhost:3001/user/applyForAdmin', formData);
  ...
  const handleRolSubmit2 = async (event) => {
    ...
    try {
      const response = await axios.post('http://localhost:3001/user/changeRol', formData);
      const requestData = response.data.requestData;
      if (!requestData.updated) {
        document.getElementById('formError').innerHTML = requestData.error;
      } else {
  ...
  const changeUserRol = async (userId, userRol) => {
    try {
      const response = await axios.post('http://localhost:3001/user/changeRol', {userRol: userRol, userId: userId});
      const requestData = response.data.requestData;
      if (!requestData.updated) {
        document.getElementById('formError').innerHTML = requestData.error;
      } else {
  ...
  const deleteUser = async () => {
    try {
      const response = await axios.post('http://localhost:3001/user/delete/', formData);
      const requestData = response.data.requestData;
  ...
  const deleteWorlds = async () => {
    try {
      const response = await axios.post('http://localhost:3001/world/deleteUserWorlds/', formData);
      const requestData = response.data.requestData;
      if (!requestData.deleted) {
        document.getElementById('buttonError').innerHTML = requestData.error;
      } else {        
